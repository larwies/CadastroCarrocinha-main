...
if(file_exists($_FILES['foto']['tmp_name'])){
    ...
    $nome_foto = $pasta_detino . date('Ymd-His').$extensao;
    ...
    <section>
        <div class="principal">
            ...
            if($nome_foto == "")
                ...
                $sql = "UPDATE animal SET foto = '$nome_foto', especie = '$especie', raca = '$raca', data_nascimento = '$dataNascimentoFormatada', castrado = $castrado, id_pessoa = $pessoa WHERE id = $id";
